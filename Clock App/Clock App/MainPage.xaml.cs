...
namespace Clock_App
{
    public partial class MainPage : ContentPage
    {
        ...
        private SKPaint GetPaintColor(SKPaintStyle style, string hexColor, float strokeWidth = 0, SKStrokeCap cap = SKStrokeCap.Round, bool IsAntialias = true) => new SKPaint
        {
            Style = style,
